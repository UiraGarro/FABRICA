...
while True:
    ...
    else:print("1. Soma  2. Subtração  3.Multiplicação  4.Divisão 5. Mostrar histórico")
        
        
        #histórico = []
        
        #if escolha == '5':
            #print(f"Histórico de contas: {histórico.append()}")
        #resultado1 = {Calculadora.soma(num1, num2)}
        #resultado2 = {Calculadora.subtração(num1, num2)}
        #resultado3 = {Calculadora.multiplicação(num1, num2)}
        #resultado4 = {Calculadora.divisão(num1, num2)}
